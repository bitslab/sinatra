...
/**
 * Define socket random and timeout function interceptors here which will intercept
 * actual Math.random(...) and setTimeout(...) calls from inside socket.io.js
 */
let realMathRandom = Math.random;

Math.socketRandom = function() {
    return realMathRandom();
}

let realSetTimeout = setTimeout;

Window.socketTimeout = function(handler, timeoutValue) {
    return realSetTimeout(handler, timeoutValue);
}
...
! function(t, e) {
    ...
    return function(t) {
        ...
        function o(t) {
            if (p === setTimeout) return Window.socketTimeout(t, 0);
            if ((p === n || !p) && setTimeout) return p = setTimeout, Window.socketTimeout(t, 0);
            try {
                return p(t, 0)
            } catch (e) {
                try {
        ...
        t.exports = r, r.prototype.emitAll = function() {
            ...
            if (!1 !== this._timeout) {
                ...
                var u = Window.socketTimeout(function() {
            ...
            if (this.backoff.attempts >= this._reconnectionAttempts) p("reconnect failed"), this.backoff.reset(), this.emitAll("reconnect_failed"), this.reconnecting = !1;
                ...
                var n = Window.socketTimeout(function() {
        ...
        t.exports = r, r.priorWebsocketSuccess = !1, s(r.prototype), r.protocol = u.protocol, r.Socket = r, r.Transport = n(23), r.transports = n(18), r.parser = n(24), r.prototype.createTransport = function(t) {
            ...
            if (this.rememberUpgrade && r.priorWebsocketSuccess && this.transports.indexOf("websocket") !== -1) t = "websocket";
                ...
                if (0 === this.transports.length) {
                    var e = this;
                    return void Window.socketTimeout(function() {
            ...
            var e = this;
            e.pingTimeoutTimer = Window.socketTimeout(function() {
                "closed" !== e.readyState && e.onClose("ping timeout")
            }, t || e.pingInterval + e.pingTimeout)
        }, r.prototype.setPing = function() {
            var t = this;
            clearTimeout(t.pingIntervalTimer), t.pingIntervalTimer = Window.socketTimeout(function() {
        ...
        if (t.exports = o, t.exports.Request = i, p(o, c), o.prototype.supportsBinary = !0, o.prototype.request = function(t) {
            ...
            try {
                ...
                "withCredentials" in e && (e.withCredentials = this.withCredentials), this.requestTimeout && (e.timeout = this.requestTimeout), this.hasXDR() ? (e.onload = function() {
                    ...
                    4 === e.readyState && (200 === e.status || 1223 === e.status ? n.onLoad() : Window.socketTimeout(function() {
        ...
        (function(e) {
            ...
            a(i, s), i.prototype.supportsBinary = !1, i.prototype.doClose = function() {
                ...
                r && Window.socketTimeout(function() {
        ...
        t.exports = r, u(r, s), r.prototype.name = "websocket", r.prototype.supportsBinary = !0, r.prototype.doOpen = function() {
            ...
            function e() {
                n.emit("flush"), Window.socketTimeout(function() {
